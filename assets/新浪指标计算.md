xh5_define("plugins.techcharts", ["utils.util", "utils.painter"], function(t, i) {
    ...
    function A(i, r) {
        ...
        this.initAndCalcAll = function(i) {
            var a = this.gdsd(i)
              , r = h(a, this.tkProp.close)
              , l = s(r, this.customArr[0].v)
              , o = s(r, this.customArr[1].v)
              , n = e(l, o, "-")
    ...
    function p(i, r) {
        ...
        var s = Ot.calcEMA
          ...
          , n = Ot.operateArr;
        this.initAndCalcAll = function(i) {
            for (var a, r, c = this.customArr[0].v, f = this.customArr[1].v, d = o(i, "close"), u = o(i, "high"), A = o(i, "low"), p = s(e(e(n(u, A, "-"), h(n(u, l(d, 1), "-"))), h(n(A, l(d, 1), "-"))), c), v = n(u, l(u, 1), "-"), g = n(l(A, 1), A, "-"), m = [], b = [], w = 0, y = v.length; y > w; w++)
                a = v[w],
                r = g[w],
                m.push(a > 0 && a > r ? a : 0),
                b.push(r > 0 && r > a ? r : 0);
