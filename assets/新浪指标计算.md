...
g = operateArr(calcREF(A, 1), A, "-"), m = [], b = [], w = 0, y = v.length; y > w; w++)
    ...
    function m(i, r) {
        ...
        this.initAndCalcAll = function(i) {
            var a = this.customArr
              ...
              , c = getArr(i, "low")
              , f = getArr(i, "volume")
              , d = operateArr(calcMA(f, 14), f, "/")
              , u = operateArr(n, c, "+")
              , A = operateArr(n, c, "-")
              , p = operateArr(operateArr(operateArr(u, calcREF(u, 1), "-"), u, "/"), 100, "*")
              , v = calcMA(operateArr(operateArr(operateArr(p, d, "*"), A, "*"), calcMA(A, 14), "/"), 14)
              , g = calcMA(v, 9);
            this.oriArr = i,
            !this.datas && (this.datas = []),
            t.ca(this.selfArr);
    ...
    function N(i, r) {
        ...
        this.initAndCalcAll = function(i) {
            ...
            this.datas ? t.ca(this.datas) : this.datas = [],
            t.ca(this.selfArr);
            for (var r = getArr(a, "close"), s = [], e = 0, h = this.customArr.length; h > e; e++)
                s.push(calcEMA(r, this.customArr[e].v));
    ...
    function B(i, r) {
        ...
        this.initAndCalcAll = function(i) {
            var a = this.gdsd(i)
              ...
              , o = 6
              , n = getArr(a, this.tkProp.close)
              , c = operateArr(operateArr(operateArr(n, calcREF(n, r), "-"), 100, "*"), calcREF(n, r), "/")
              , f = calcMA(c, o);
            this.oriArr = a,
            this.datas ? t.ca(this.datas) : this.datas = [],
            t.ca(this.selfArr);
    ...
    function K(i, r) {
        ...
        this.initAndCalcAll = function(i) {
            var a = this.gdsd(i)
              , r = 12
              , n = 9
              , c = getArr(a, this.tkProp.close)
              , f = calcEMA(calcEMA(calcEMA(c, r), r), r)
              , d = calcREF(f, 1)
              , u = operateArr(operateArr(operateArr(f, d, "-"), d, "/"), 100, "*")
              , A = calcMA(u, n);
            this.oriArr = a,
            this.datas ? t.ca(this.datas) : this.datas = [],
            t.ca(this.selfArr);
    ...
    function J(i, r) {
        ...
        var s = Ot.calcMA
          ...
          , o = Ot.operateArr;
        this.initAndCalcAll = function(i) {
            for (var a = this.gdsd(i), 
r = this.customArr[0].v, 
n = this.customArr[1].v, 
c = getArr(a, this.tkProp.close), f = getArr(a, "volume"), d = calcREF(c, 1), u = [], A = [], p = [], v = 0, g = c.length; g > v; v++)
            ...
            A = calcSUM(A, r),
            p = calcSUM(p, r);
            var m = operateArr(operateArr(operateArr(operateArr(u, 2, "*"), p, "+"), 100, "*"), operateArr(operateArr(A, 2, "*"), p, "+"), "/")
              , b = calcMA(m, 6);
            this.oriArr = a,
            this.datas ? t.ca(this.datas) : this.datas = [],
            t.ca(this.selfArr);
    ...
    function tt(i, r) {
        ...
        this.initAndCalcAll = function(i) {
            var a = this.customArr
              ...
              , d = l(i, "low")
              , u = l(i, "volume")
              , A = operateArr(calcSUM(operateArr(operateArr(operateArr(n, c, "-"), operateArr(f, d, "-"), "/"), u, "*"), r), 1e4, "/")
              , p = calcMA(A, o);
            this.oriArr = i,
            !this.datas && (this.datas = []),
            t.ca(this.selfArr);
